...
namespace Script
{
    ...
    public static class TempImages
    {
        ...
        /// 一号狗粮坐标
        /// </summary>
        public static System.Drawing.Rectangle GL1_Rect = new System.Drawing.Rectangle(599, 510, 160, 100);
        /// <summary>
        /// 2号狗粮坐标
        /// </summary>
        public static System.Drawing.Rectangle GL2_Rect = new System.Drawing.Rectangle(856, 510, 160, 100);
        /// <summary>
        /// 3号狗粮坐标
        /// </summary>
        public static System.Drawing.Rectangle GL3_Rect = new System.Drawing.Rectangle(325, 600, 160, 100);
        /// <summary>
        /// 胜利的模板
        /// </summary>
        public static Image<Bgr, byte> VectorTemp = new Image<Bgr, byte>(rootPath.AppendPath("vector.png"));
        /// <summary>
        /// 失败的模板
        /// </summary>
        public static Image<Bgr, byte> FailTemp = new Image<Bgr, byte>(rootPath.AppendPath("fail.png"));
        /// <summary>
        /// 进度条的模板
        /// </summary>
        public static Image<Bgr, byte> BarTemp = new Image<Bgr, byte>(rootPath.AppendPath("bar.png"));
        /// <summary>
        /// 结束后选择的模板
        /// </summary>
        public static Image<Bgr, byte> EndSelectTemp = new Image<Bgr, byte>(rootPath.AppendPath("end.png"));
        /// <summary>
        /// 是否获取道具的模板
        /// </summary>
        public static Image<Bgr, byte> GetTemp = new Image<Bgr, byte>(rootPath.AppendPath("get.png"));
        /// <summary>
        /// 是否获取道具的模板
        /// </summary>
        ...
        /// 体力不足的模板
        /// </summary>
        public static Image<Bgr, byte> EnergyNotEnoughTemp = new Image<Bgr, byte>(rootPath.AppendPath("nlg.png"));
        ...
        /// 最大等级模板
        /// </summary>
        public static Image<Bgr, byte> MaxLevelTemp = new Image<Bgr, byte>(rootPath.AppendPath("maxlevel.png"));
        /// <summary>
        /// 最大等级模板
        /// </summary>
        public static Image<Bgr, byte> MaxLevel2Temp = new Image<Bgr, byte>(rootPath.AppendPath("maxlevel2.png"));
        /// <summary>
        /// 最大等级模板
        /// </summary>
        public static Image<Bgr, byte> FuHuoTemp = new Image<Bgr, byte>(rootPath.AppendPath("fuhuo.png"));
        /// <summary>
        /// 战利品框
        /// </summary>
